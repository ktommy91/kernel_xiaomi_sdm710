...
#ifdef CONFIG_SND_SOC_TFA9874_FOR_GRUS
static struct snd_soc_dai_link msm_int_tfa_dai[] = {
	{/* hw:x,40 */
...
#ifdef CONFIG_SND_SOC_TFA9874_FOR_GRUS
	memcpy(dailink + len1, msm_int_tfa_dai, sizeof(msm_int_tfa_dai));
	len1 += ARRAY_SIZE(msm_int_tfa_dai);
#else
